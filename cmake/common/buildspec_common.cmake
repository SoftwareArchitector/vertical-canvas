...
function(_check_dependencies)
  ...
  foreach(dependency IN LISTS dependencies_list)
    ...
    message(STATUS "Destination: ${dependencies_dir}/${destination}")
	...
	execute_process(COMMAND rm "${dependencies_dir}/obs-studio-31.0.3.20250525")
	execute_process(COMMAND mv "${dependencies_dir}/obs-studio-vertical-31.0.3.20250525" "${dependencies_dir}/obs-studio-31.0.3.20250525")
      else()
